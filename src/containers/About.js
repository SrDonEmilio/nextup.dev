      ...
      <div id="site-container">
        ...
        <div id="profile">
          <div id="profile-header">
            ...
            <img src={imgProfileMobile} alt="profile-img-mobile" id="profile-img-mobile" />
          </div>
          <div id="profile-contact">
                <a href="mailto:emiliomtzju@gmail.com"><img className="img-icon" src={iconMail} alt="icon-mail"></img></a>
                <a href="https://www.linkedin.com/in/emiliomtzjua/"><img className="img-icon" src={iconLinkeIn} alt="icon-linkedin"></img></a>
                <a href="https://github.com/SrDonEmilio"><img className="img-icon" src={iconGitHub} alt="icon-github"></img></a>
                <a href="https://twitter.com/SrDonEmilio"><img className="img-icon" src={iconTwitter} alt="icon-twitter"></img></a>
          </div>
        </div>
      </div>
    </div>
